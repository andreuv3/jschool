...
CREATE TABLE IF NOT EXISTS instituicao(
	...
	CONSTRAINT fk_instituicao_cidade FOREIGN KEY (id_cidade) REFERENCES cidade (id)
);
...
CREATE TABLE IF NOT EXISTS curso(
	...
	horas_duracao DECIMAL(10,2) NOT NULL,
	vagas_recomendadas INT,
...
CREATE TABLE IF NOT EXISTS turma(
	...
	horario_fim_aula TIME NOT NULL,
	vagas INT NOT NULL,
	sala VARCHAR(10) NULL,
	tipo_media SMALLINT NOT NULL,
	media_aprovacao NUMERIC(10,2) NOT NULL,
	status SMALLINT NOT NULL,
	CONSTRAINT pk_turma PRIMARY KEY (id),
	CONSTRAINT fk_turma_curso FOREIGN KEY (id_curso) REFERENCES curso (id),
	CONSTRAINT fk_turma_professor FOREIGN KEY (id_professor) REFERENCES professor (id_pessoa)
);


-- TABELA INSCRICAO_TURMA
CREATE TABLE IF NOT EXISTS inscricao_turma(
	id SERIAL NOT NULL,
	data_inscricao DATE NOT NULL,
	status SMALLINT NOT NULL,
	media_aluno NUMERIC(10, 2),
	situacao_aluno SMALLINT,
	id_aluno INT NOT NULL,
	id_turma INT NOT NULL,
	CONSTRAINT pk_inscricao_turma PRIMARY KEY (id),
	CONSTRAINT fk_inscricao_turma_aluno FOREIGN KEY (id_aluno) REFERENCES aluno (id_pessoa),
	CONSTRAINT fk_inscricao_turma_turma FOREIGN KEY (id_turma) REFERENCES turma (id)
);

-- TABELA DIA_SEMANA_TURMA
CREATE TABLE IF NOT EXISTS dia_semana_turma(
	id SERIAL,
	dia_semana INT NOT NULL,
	id_turma INT NOT NULL,
	CONSTRAINT pk_dia_semana_turma PRIMARY KEY (id),
	CONSTRAINT fk_dia_semana_turma_turma FOREIGN KEY (id_turma) REFERENCES turma (id)
);

-- TABELA DIA_LETIVO_TURMA
CREATE TABLE IF NOT EXISTS dia_letivo_turma(
	id SERIAL,
	id_turma INT NOT NULL,
	data_aula DATE NOT NULL,
	CONSTRAINT pk_dia_letivo PRIMARY KEY (id),
	CONSTRAINT fk_dia_letivo_turma FOREIGN KEY (id_turma) REFERENCES turma (id)
);
...
CREATE TABLE IF NOT EXISTS frequencia(
	...
	id_inscricao_turma INT NOT NULL,
	CONSTRAINT pk_frequencia PRIMARY KEY (id),
	CONSTRAINT fk_frequencia_inscricao_turma FOREIGN KEY (id_inscricao_turma) REFERENCES inscricao_turma (id)
);


-- INSERÇÕES

-- INSERCAO DOS ESTADOS DO BRAIL
...
-- INSERCAO DAS CIDADES DO BRAIL (2017)
...
-- INSERCAO DA INSTITUICAO PADRAO
INSERT INTO instituicao (id, nome, cnpj, inscricao_estadual, telefone, email, site, logradouro, numero, complemento, bairro, id_cidade)
VALUES (1, 'Instituição Modelo', '92086381000191', '298712485159', '5434526714', 'email@instituicao.com', 'www.instituicao.com.br', 'Logradouro', '123', 'Complemento', 'Bairro', 4081); 

-- INSERCAO DO USUARIO ADMININISTRADOR
INSERT INTO usuario (nome, senha, tipo) VALUES ('admin', '202cb962ac59075b964b07152d234b70', 1);
