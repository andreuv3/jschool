 ...
 * @author andre
 */
public class ProfessorTM extends AbstractTableModel{
    private List<IEntidade> linhas;
    //Nomes das colunas da tabela
    private String[] colunas = new String[]{"Codigo", "Nome", "Número CTPS", "Data Adm.", "Cidade", "Situação"};
    //Constantes representando o índice das colunas
    private static final int CODIGO = 0;
    private static final int NOME = 1;
    private static final int NUMERO_CTPS = 2;
    private static final int DATA_ADM = 3;
    ...
    public ProfessorTM(List<IEntidade> linhas) {
        this.linhas = linhas;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case NOME:
                return p.getNome();
            case NUMERO_CTPS:
                return p.getNumeroCtps();
            case DATA_ADM:
                return p.getDataAdmissao();
            case CIDADE:
                return p.getCidade().getNome();
            case SITUACAO:
                return p.getSituacaoString();
            default:
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case NUMERO_CTPS:
                p.setNumeroCtps((String) aValue);
            case DATA_ADM:
                p.setDataNascimento((Date) aValue);
            case CIDADE:
                p.setCidade((Cidade) aValue);
            case SITUACAO:
                p.setSexo((Sexo) aValue);
            default:
                //Não deve ocorrer, pois só existem 2 colunas
                throw new IndexOutOfBoundsException("columnIndex out of bounds");
        }
