...
public class AlunoTM extends AbstractTableModel{
    ...
    private String[] colunas = new String[]{"Codigo", "Aluno", "Matrícula", "Data Matrícula", "Cidade", "Situação"};
    ...
    public AlunoTM(List<IEntidade> linhas) {
        this.linhas = linhas;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case DATA_MATRICULA:
                return a.getDataMatricula();
            case CIDADE:
                return a.getCidade().getNome();
            case SITUACAO:
                return a.getSituacaoString();
            default:
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case DATA_MATRICULA:
                a.setDataMatricula((Date) aValue);
            case CIDADE:
                a.setCidade((Cidade) aValue);
            case SITUACAO:
                a.setSituacao((Situacao) aValue);
            default:
                //Não deve ocorrer, pois só existem 2 colunas
                throw new IndexOutOfBoundsException("columnIndex out of bounds");
        }
