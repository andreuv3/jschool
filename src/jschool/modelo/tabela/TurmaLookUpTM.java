 ...
 * @author andre
 */
public class TurmaLookUpTM extends AbstractTableModel {

    private List<IEntidade> linhas;
    //Nomes das colunas da tabela
    private String[] colunas = new String[]{"Codigo", "Curso", "Professor", "Descrição"};
    ...
    public TurmaLookUpTM() {
        this.linhas = new ArrayList<>();
    }

    public TurmaLookUpTM(List<IEntidade> linhas) {
        this.linhas = linhas;
    }
