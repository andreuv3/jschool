...
import jschool.modelo.tabela.DiaLetivoTM;

/**
 *
 * @author andre
 */
public class JIFrameFrequencias extends javax.swing.JInternalFrame {

    private Turma turma;
    private ArrayList<IEntidade> diasLetivos;

    public JIFrameFrequencias() {
        initComponents();
    ...
    private void carregarDiasLetivos() {
        
        DiaLetivoTM tabelaDiasLetivos = new DiaLetivoTM();
        this.diasLetivos = new DiaLetivoDAO().consultarAulasTurma(this.turma);
        
        tabelaDiasLetivos.addListaDiasLetivos(this.diasLetivos);
        jtbDiasLetivos.setModel(tabelaDiasLetivos);
    }
    ...
    private void initComponents() {
        ...
        jtbDiasLetivos = new javax.swing.JTable();
        ...
        jbtAdicionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/jschool/icons/add24.png"))); // NOI18N
        ...
        jtbDiasLetivos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        jScrollPane2.setViewportView(jtbDiasLetivos);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jbtAdicionar, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jbtAdicionar, jbtAlterar, jbtSair});
    ...
    private void jbtAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtAdicionarActionPerformed
        try {
            Date dataAula = (Date) jtbDiasLetivos.getModel().getValueAt(jtbDiasLetivos.getSelectedRow(), 1);
                        
            //Verifica se é maior que a data atual
            if(dataAula.getTime() > new Date().getTime()){
                Mensagem.aviso("Você só pode atribuir frequência de aulas que já aconteceram");
                return;
            }
            
            if(new FrequenciaDAO().frequenciaRegistrada(this.turma, dataAula)){
                Mensagem.aviso("As frequências já foram registradas, clique em alterar");
                return;
            }
            
            JDFrequencia dialogFrequencias = new JDFrequencia(null, true, dataAula, this.turma, false);
            dialogFrequencias.setVisible(true);
        } catch (Exception e) {
            Mensagem.erro("Problema ao incluir frequências");
        }
    ...
    private void jbtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtAlterarActionPerformed
        try {
            ...
            if(!new FrequenciaDAO().frequenciaRegistrada(this.turma, dataAula)){
                Mensagem.aviso("As frequências ainda não foram registradas, clique em adicionar");
                return;
            }
            
            JDFrequencia dialogFrequencias = new JDFrequencia(null, true, dataAula, this.turma, true);
            dialogFrequencias.setVisible(true);
        } catch (Exception e) {
            Mensagem.erro("Problema ao alterar frequências");
        }
    ...
    private javax.swing.JTable jtbDiasLetivos;
